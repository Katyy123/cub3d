...
/*   Updated: 2022/11/17 18:23:34 by tom              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int wall_b(t_game *game)
{
    ...
    test_a = 3.14 - game->pl.pov - (3.14 /2);
    while (test_a < (3.14 - game->pl.pov + (3.14 /2)))
    {
        test_x = game->pl.pos_x - cos(test_a);
        test_y = game->pl.pos_y - sin(test_a);
        if (game->map[(int)test_y][(int)test_x] == '1')
...
int wall_dx(t_game *game)
{
    ...
    test_a = game->pl.pov + 3.14/2 - (3.14 /2);
    while (test_a < (game->pl.pov + 3.14/2 + (3.14 /2)))
    {
        test_x = game->pl.pos_x + cos(test_a);
        test_y = game->pl.pos_y + sin(test_a);
        if (game->map[(int)test_y][(int)test_x] == '1')
